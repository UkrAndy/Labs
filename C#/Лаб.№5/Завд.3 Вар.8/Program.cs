...
namespace Завд._3_Вар._8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                el = (1 - (x * x) / (((n - 1) * (n - 1)) * (Math.PI * Math.PI)));       //x^2 краще було один раз обчислити і записати у окрему змінну. Для піднесення до степені використовуйте відповідні функції
                d *= el;
                n++;
